...
export class PatientListComponent implements AfterViewInit {
  ...
  displayedColumns: string[] = ['position', 'name', 'mobile', 'allocateid', 'email'];
  ...
  ngAfterViewInit() {
    ...
    //   this.ELEMENT_DATA = [
    //     { position: element.position, name: element.name , mobile: element.mobile, allocateid: element.allocateid, email: element.email },
    //   ]
